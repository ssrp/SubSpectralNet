    ...
    for fold in folds:
        ...
        if not os.path.isfile(fold_model_filename) or overwrite:
            ...
            if param.get_path('learner.parameters.generator.enable'):
                ...
                import numpy as np
                np.save('X_train_left_40.npy', X_train)
                np.save('Y_train_left_40.npy', Y_train)
                np.save('X_validation_left_40.npy', X_validation)
                np.save('Y_validation_left_40.npy', Y_validation)
